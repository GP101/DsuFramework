...
{
    [CustomEditor(typeof(HighlightCollider2D))]
    public class HighlightCollider2DEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Remove")) {
                HighlightCollider2D targetScript = (HighlightCollider2D)target;
